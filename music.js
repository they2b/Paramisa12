...
setInterval(() => {
  http.get(`http://paramisa1234.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const GUILDID = '557921698725494784'; //  تعديل مهم ايدي السيرفر  
const CHANNELID = '557954573101170688'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["403764928210796547","454062883274489856","336088221123346446",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
...
const youtube = new YouTube("AIzaSyDNQv_4hyY9TQKqXcvZauCYMPGMsut07Kc"); 
